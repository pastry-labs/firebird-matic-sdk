...
import { ChainId, CurrencyAmount, ETHER, Pair, Percent, Route, Router, Token, TokenAmount, Trade, WMATIC } from '../src'
...
describe('Router', () => {
  ...
  const pair_weth_0 = new Pair(new TokenAmount(WMATIC[ChainId.MATIC], '1000'), new TokenAmount(token0, '1000'))
    ...
    describe('exact in', () => {
      it('ether to token1', () => {
        ...
        expect(result.args.slice(0, -1)).toEqual([
          '0x51',
          [WMATIC[ChainId.MATIC].address, token0.address, token1.address],
      ...
      it('token1 to ether', () => {
        ...
        expect(result.args.slice(0, -1)).toEqual([
          '0x64',
          '0x51',
          [token1.address, token0.address, WMATIC[ChainId.MATIC].address],
          '0x0000000000000000000000000000000000000004'
        ])
