...
import { ChainId, WMATIC as _WETH, TradeType, Rounding, Token, TokenAmount, Pair, Route, Trade } from '../src'
...
const CHAIN_ID = ChainId.FTMTESTNET
const WETH = _WETH[ChainId.FTMTESTNET]
